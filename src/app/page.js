      ...
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        <div className="space-y-8">
          ...
          <div className="space-y-5">
            <h1 className="max-w-4xl text-5xl font-black leading-[0.95] tracking-[-0.06em] text-[var(--nav-brand)] sm:text-6xl lg:text-7xl">
              Save, shape, and ship your next breakout idea.
            </h1>
            <p className="max-w-2xl text-base leading-8 text-[var(--nav-foreground-muted)] sm:text-lg">
              IdeaVault gives founders a polished space to capture sharp ideas,
              revisit momentum, and keep every promising concept moving.
            </p>
          </div>
          ...
          <div className="relative space-y-5">
            <div className="flex items-center justify-between rounded-2xl border border-[var(--nav-border)] bg-[var(--nav-surface-soft)] p-4">
              <div>
                ...
                <p className="mt-2 text-3xl font-black tracking-[-0.05em] text-[var(--nav-brand)]">
                  24 active
                </p>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-[var(--nav-border)] bg-[var(--nav-surface-soft)] p-5">
                ...
                <p className="mt-3 text-3xl font-black tracking-[-0.05em] text-[var(--nav-brand)]">
                  18
                </p>
              </div>
              <div className="rounded-2xl border border-[var(--nav-border)] bg-[var(--nav-surface-soft)] p-5">
